...
function markAttendance(e) {
  ...
  const body = {
    ...
    shyam: e.target.shyam.value,
    jadu: e.target.jadu.value,
    madhu: e.target.madhu.value,
    hari: e.target.hari.value,
    oishi: e.target.oishi.value,
    titli: e.target.titli.value,
    nobita: e.target.nobita.value,
